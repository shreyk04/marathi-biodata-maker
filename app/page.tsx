      ...
      <>
        ...
        <div className="flex flex-col items-center justify-center gap-2 my-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center w-full gap-5 my-2">
            <Button variant={isWithPhotoFilterActive ? "default": "outline"} onClick={()=>setIsWithPhotoFilterActive(true)}>
              <span>फोटो सोबत</span>
              <span>
                <MoveRight className="ml-2" />
              </span>
            </Button>
            <Button variant={!isWithPhotoFilterActive ? "default": "outline"} onClick={()=>setIsWithPhotoFilterActive(false)}>
